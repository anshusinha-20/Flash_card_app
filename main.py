...
buttonWrong = Button(image=wrongImage, bd=0, highlightthickness=0, command=changeToFront)
buttonWrong.grid(row=2, column=1)

"""created the buttonWrong object"""
rightImage = PhotoImage(file="images/right.png")
buttonWrong = Button(image=rightImage, bd=0, highlightthickness=0, command=changeToFront)
